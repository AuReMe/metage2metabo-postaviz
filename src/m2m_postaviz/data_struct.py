...
class DataStorage:
    def __init__(self, main_data_container: dict, sample_data_container: dict, taxonomic_data_container: pd.DataFrame):
    ...
    def get_bin_list(self, mode: str = "cscope"):
        ...
        for sample in self.sample_data.keys():
            bin_list[sample] = self.sample_data[sample][mode]["Name"].to_list()
        return bin_list
